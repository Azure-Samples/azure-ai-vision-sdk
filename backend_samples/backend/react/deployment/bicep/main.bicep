/*
  ...
  Creates the resource group and delegates all resource creation to
...
@description('Owner tag value applied to the resource group (required by policy)')
param owner string

resource resourceGroup 'Microsoft.Resources/resourceGroups@2021-04-01' = {
  name: 'liveness-react-${env}-${locationabbr}'
  location: location
  tags: {
    owner: owner
  }
...
@description('Default hostname of the deployed web app, e.g. liveness-react-dev-eus.azurewebsites.net')
