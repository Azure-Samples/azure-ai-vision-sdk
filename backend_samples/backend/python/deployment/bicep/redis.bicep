...
var redisName = 'liveness-py-${env}-${locationabbr}'
...
// EnterpriseCluster policy exposes a single endpoint so the standard redis-py client
// (not RedisCluster) keeps working unchanged.
