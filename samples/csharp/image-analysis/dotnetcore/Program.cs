    ...
    static void Main(string[] args)
    {
        ...
        do
        {
            ...
            try
            {
                ...
                {
                    case '1':
                        Samples.ImageAnalysisSample_Analyze(Secrets.Endpoint, Secrets.Key);
                        break;
                    case '2':
                        Samples.ImageAnalysisSample_AnalyzeAsync(Secrets.Endpoint, Secrets.Key).Wait();
                        break;
                    case '3':
                        Samples.ImageAnalysisSample_AnalyzeWithCustomModel(Secrets.Endpoint, Secrets.Key);
                        break;
                    case '4':
