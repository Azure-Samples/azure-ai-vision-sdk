...
public class Samples
{
    ...
    public static void ImageAnalysisSample_Analyze_File(string endpoint, string key)
    {
    ...
    public static async Task ImageAnalysisSample_AnalyzeAsync_Url(string endpoint, string key)
    {
        var serviceOptions = new VisionServiceOptions(endpoint, new AzureKeyCredential(key));

        using var imageSource = VisionSource.FromUrl(new Uri("https://aka.ms/azai/vision/image-analysis-sample.jpg"));
    ...
    public static void ImageAnalysisSample_Analyze_Buffer(string endpoint, string key)
    {
        var serviceOptions = new VisionServiceOptions(endpoint, new AzureKeyCredential(key));
        ...
        var analysisOptions = new ImageAnalysisOptions() { Features = ImageAnalysisFeature.Caption };
    ...
    public static void ImageAnalysisSample_Analyze_WithCustomModel(string endpoint, string key)
    {
        var serviceOptions = new VisionServiceOptions(endpoint, new AzureKeyCredential(key));
